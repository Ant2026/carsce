document.addEventListener("DOMContentLoaded", function () {
    ...
    function cargarMunicipios() {
        municipioSelect.innerHTML = '<option disabled selected hidden>Elija el Municipio</option>';
    ...
    function actualizarParroquias() {
        ...
        parroquiaSelect.innerHTML = '<option disabled selected hidden>Elije la Parroquia</option>';
